...
<main class="w-full h-dvh flex flex-col">
    ...
    <form class="h-full w-fit mx-16 mb-16 p-4 flex flex-col" action="/notes/<?= $note['id'] ?>" method="POST">
        ...
        <div class="flex gap-4 justify-end items-center mt-8">
            ...
            <button class="place-self-end w-fit p-2 rounded-md shadow-md bg-white font-medium hover:text-blue-500">Save
                Changes</button>
        </div>
